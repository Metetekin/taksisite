<?php
  ...
  if( $user["access"]["galeri"] != 1  ):
    ...
    $orders         = $conn->prepare("SELECT * FROM files WHERE file_type='1' ");
...
$file_name = $_POST["file_name"];
            ...
            $insert->execute(array("file_name"=>$file_name,"file_url"=>$logo_newname,"file_type"=>1,"file_date"=>date("Y.m.d H:i:s") ));
            
            header("Location: ".site_url("admin/katalog"));
