            ...
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title"><i class="fas fa-file-alt" aria-hidden="true"></i> Sayfa Detayı <small>(<?php echo $order["page_id"]; ?>)</small></h4>
                  </div>
               </div>
               <div class="card-body">
...
<hr>
              ...
              ?>
                           ...
                           <a href="<?=site_url("admin/sayfa_Detay/sil/$id")?>" class="btn btn-danger">Sayfayı Sil</a>
                  </form>
               </div>
            </div>
         </div>
