          ...
          foreach( $orders as $order ): 
             ...
             $id = $order["page_id"];            
              ...
              <tr>
                 ...
                 <td>
                     <a href="<?=site_url("admin/blog_detay/$id")?>"><button type="button" class="btn btn-dark"><i class="fas fa-edit"></i>Düzenle</button></a>
                                                           <a href="<?=site_url("admin/blog_detay/sil/$id")?>"><button type="button" class="btn btn-danger"><i class="fas fa-trash"></i>Sil</button></a>
