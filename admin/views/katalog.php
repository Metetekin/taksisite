...
<div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="exampleModalLabel">Katalog yükle</h5>
                 ...
                 <label>Katalog dosyası</label><br>             
                ...
                <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">Kataloglar</h4>
                     </div>
                  </div>
                  <div class="card-body">
          ...
          foreach( $orders as $order ): 
             ...
             $id = $order["file_id"];            
              ...
              <tr>
                 ...
                 <td>
                     <a href="<?=site_url("admin/katalog?delete=$id")?>"><button type="button" class="btn btn-danger"><i class="fas fa-trash"></i>Sil</button></a>
