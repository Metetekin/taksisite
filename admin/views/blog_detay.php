            ...
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title"><i class="fas fa-swatchbook" aria-hidden="true"></i> Blog Detayı <small>(<?php echo $order["page_id"]; ?>)</small></h4>
                  </div>
               </div>
               <div class="card-body">
...
<hr>
              ...
              ?>
                           ...
                           <button type="submit" class="btn btn-primary ">Blog Yazısını Güncelle</button>
                           <a href="<?=site_url("admin/hizmet_detay/sil/$id")?>" class="btn btn-danger">Blog Yazısını Sil</a>
                  </form>
               </div>
            </div>
         </div>
